...
r^{m+1}+o(r^{m+1})$.%\footnote{These two questions answered affirmatively in }
...
Then  taking in the above inequality $c>3N/\sin^2\eps$, we get that the function
...
\noi{\bf \ref{conj:bry}$'\!\!\!$. Conjecture.}{\it\ Let $A$ be Alexandrov space without boundary.
Then a convex hypersurface in $A$ equipped with induced intrinsic metric is Alexandrov's space with the same lower curvature bound.}
